    ...
    <div className='project-card'>
      ...
      <div className='back-card'>
        ...
        <div>
          ...
          <a href={el.live} target='_blank' rel="noopener noreferrer">Live</a>
        </div>
        ...
        <div className='about-container'>
          ...
          <div id='txt' >
            ...
            <div className='links' >
              ...
              <svg viewBox="0 0 128 128" className='icon' onClick={github} target='_blank' rel="noopener noreferrer">
